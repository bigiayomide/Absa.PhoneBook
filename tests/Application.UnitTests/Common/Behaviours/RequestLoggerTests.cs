...
namespace Absa.Application.UnitTests.Common.Behaviours
{
    ...
    public class RequestLoggerTests
    {
        ...
        {
            _logger = new Mock<ILogger<CreatePhoneBookEntryCommand>>();
        ...
        public async Task ShouldCallGetUserNameAsyncOnceIfAuthenticated()
        {
            ...
            var requestLogger = new LoggingBehaviour<CreatePhoneBookEntryCommand>(_logger.Object, _currentUserService.Object, _identityService.Object);

            await requestLogger.Process(new CreatePhoneBookEntryCommand { PhoneBookId = 1, Name = "title" }, new CancellationToken());
